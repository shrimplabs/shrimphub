...
func test_spawn_entities_parallel_returns_array() -> void:
	var result = _main.spawn_entities_parallel(["Entity1", "Entity2", "Entity3"])
...
func test_spawn_entities_parallel_assigns_correct_names() -> void:
	...
	var spawned_entities = state.get("spawned_entities")
...
func test_spawn_entities_parallel_emits_signal() -> void:
	...
	_main.entities_spawned.connect(func(count, names):
	...
	assert_eq(received_names, names, "signal should report correct names")

func test_spawn_entities_parallel_handles_empty_array() -> void:
	var initial_count = _main.get_spawned_count()
	var result = _main.spawn_entities_parallel([])
...
func test_spawn_entities_parallel_with_delay_sets_processing_flag() -> void:
	...
	_main.spawn_entities_parallel_with_delay(["D1", "D2"], 50.0)
	assert_false(_main.is_processing_parallel(), "should not be processing after spawn")
...
func test_get_pending_spawn_count_returns_int() -> void:
	var count = _main.get_pending_spawn_count()
