...
- update_knowledge(content): Save persistent structural facts (module layout, patterns, gotchas) — appended and compacted over time
- update_validation_state(content): Overwrite current validation status and test commands — always replaces, never appends
